...
For creating and storing users i used Django’s built in authentication system django.contrib.auth.models and imported the User class.
...
* Created a new repository within GitHub using the Code-institute full-template.
* Opening the repository using Gitpod.

The code was commited to Git and pused to Github using the command line interface
